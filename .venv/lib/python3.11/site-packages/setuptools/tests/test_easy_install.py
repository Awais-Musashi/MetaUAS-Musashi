...
def test_editable_user_and_build_isolation(setup_context, monkeypatch, tmp_path):
    ...
    #            "/media/user/.pyenv/versions/3.9.10 "
    #            "/media/user/.pyenv/versions/3.9.10/lib "
    #            "/media/user/.pyenv/versions/3.9.10/lib/python3.9 "
    #            "/media/user/.pyenv/versions/3.9.10/lib/python3.9/lib-dynload")
